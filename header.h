...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/27 17:31:43 by dprovorn          #+#    #+#             */
/*   Updated: 2017/01/27 18:11:46 by dprovorn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define FA 			int i = 1, k = -1, j, m, **found_path = NULL, w;
...
int						ft_simulate(int **paths, int fur, int en, int8_t para);
#endif
